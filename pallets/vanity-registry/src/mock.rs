...
parameter_types! {
		...
		pub const RegisterPeriod: <Test as frame_system::Config>::BlockNumber = 95;
		pub const FundToLock: <Test as pallet_balances::Config>::Balance = 57;
